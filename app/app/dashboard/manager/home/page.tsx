...
export async function generateMetadata() {
  return generateMeta({
    title: "Manager Dashboard - Project Management",
    description:
      "The project management dashboard provides a powerful and intuitive interface for tracking tasks, deadlines, and team progress to ensure project success.",
    canonical: "/dashboard/manager/home"
  });
}
