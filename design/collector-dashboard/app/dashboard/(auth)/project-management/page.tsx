...
export async function generateMetadata() {
  return generateMeta({
    title: "VPS Provider Dashboard",
    description:
      "The VPS provider management dashboard provides a comprehensive interface for monitoring server performance, customer management, and infrastructure status.",
  ...
  return (
    <>
      <div className="mb-4 flex flex-row items-center justify-between space-y-2">
        <h1 className="text-2xl font-bold tracking-tight">VPS Provider Dashboard</h1>
