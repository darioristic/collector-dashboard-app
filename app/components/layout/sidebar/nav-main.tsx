...
export const navItems: NavGroup[] = [
  {
    ...
    items: [
      ...
      },
      {
        ...
        icon: Building2Icon,
        items: [
          { title: "Companies", href: "/dashboard/contacts/companies" },
          { title: "Contacts List", href: "/dashboard/contacts/list" },
          { title: "Relationships", href: "/dashboard/contacts/relationships" }
        ]
      },
      {
        title: "Sales",
        ...
        items: [
          { title: "Offers", href: "/dashboard/sales/offers" },
      ...
      },
      {
        ...
        items: [
          { title: "Deliveries", href: "/dashboard/operations/deliveries" }
        ]
      },
      {
        title: "Finance",
