...
export function AchievementByYear() {
  return (
    <Card className="xl:col-span-1">
      <CardHeader>
        <CardTitle>Server Growth by Year</CardTitle>
        <CardDescription>
          You deployed more VPS instances per month on average this year than last year.
        </CardDescription>
      </CardHeader>
      <CardContent className="grid gap-4">
        <div className="grid auto-rows-min gap-2">
          <div className="flex items-baseline gap-1 text-2xl leading-none font-semibold tabular-nums">
            57
            <span className="text-muted-foreground text-xs font-normal">instances</span>
          </div>
          <ChartContainer
            config={{
              steps: {
