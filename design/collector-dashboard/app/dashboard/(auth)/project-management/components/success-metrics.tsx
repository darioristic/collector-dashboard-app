  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardTitle className="font-display text-2xl lg:text-3xl">1,423</CardTitle>
      </CardHeader>
      <CardContent>
        ...
        <p className="mt-8 mb-2 text-sm font-bold">Performance Metrics</p>
        <div className="divide-y *:py-3">
          ...
          <div className="flex justify-between text-sm">
            ...
            <span className="flex items-center gap-1">
              <ArrowUpRight className="size-4 text-green-600" /> 45%
            </span>
          </div>
        </div>
      </CardContent>
