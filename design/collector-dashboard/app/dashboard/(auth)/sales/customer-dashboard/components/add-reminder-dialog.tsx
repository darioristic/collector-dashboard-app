  ...
  const [reminders, setReminders] = React.useState<Reminder[]>([
    {
      ...
      date: "Today",
      time: "14:30",
      text: "Follow up with premium customer about renewal.",
    ...
    },
    {
      ...
      date: "Today",
      time: "11:00",
      text: "Schedule customer satisfaction survey.",
      category: "Survey"
    },
    {
      id: 3,
      ...
      date: "Tomorrow",
      time: "15:30",
      text: "Review customer feedback and complaints.",
  ...
  return (
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent className="sm:max-w-[425px]">
        <DialogHeader>
          <DialogTitle>Add New Customer Reminder</DialogTitle>
        </DialogHeader>
        <div className="mt-4 grid space-y-6">
          ...
          <div className="grid gap-2">
            ...
            <Select
              ...
              <SelectContent>
                <SelectItem value="Customer Follow-up">Customer Follow-up</SelectItem>
